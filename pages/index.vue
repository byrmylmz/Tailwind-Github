      ...
      <div class="flex item-center space-x-4">
        ...
        <div class="relative">
          ...
          <div class="absolute top-0 right-0 flex items-center h-full">
            <div
              class="border border-gray-600 rounded tex-xs text-gray-400 px-2 mr-2"
            >
              /
            </div>
          </div>
    ...
    <div class="repo-stats flex items-center justify-between px-8 py-4">
      ...
      <div class="flex space-x-3">
        <div class="flex text-xs">
          <button class="border border-gray-400 rounded rounded-r-none px-3 py-1 ">hih</button>
          <button class="border border-gray-400 border-l-0 rounded rounded-l-none px-3 py-1 font-semibold hover:text-blue-500">tiks</button>
        </div>
      </div>
    </div>
  </div>
